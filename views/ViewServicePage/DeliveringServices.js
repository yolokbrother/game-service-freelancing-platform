...
import ViewDeliveringServicesPaginationTable from './ViewDeliveringServicesPaginationTable';
...
export default function DeliveringServices() {
    //state
        ...
        <Container maxWidth="md" sx={{ mt: 5, mb: 5 }}>
          <Box sx={{ width: '100%', textAlign: 'center', display: 'flex', flexWrap: 'wrap', flexDirection: 'column' }} border={1}>
            ...
            <div style={{ height: 400, width: "100%" }}>
              <ViewDeliveringServicesPaginationTable ordersData={ordersData} />
            </div>
          </Box>
        </Container>
      </div>
